    ...
    return (
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        ...
        >
          ...
          <div
            className="flex h-full flex-col bg-sidebar text-sidebar-foreground w-(--sidebar-width) shadow-lg transition-[width,max-width] duration-300 ease-in-out will-change-[transform,width]"
          >
            {children}
          </div>
        </SheetContent>
  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={cn(
          "fixed inset-y-0 z-10 hidden h-svh w-(--sidebar-width) transition-[width] duration-300 ease-in-out overflow-hidden will-change-[width] md:flex",
          side === "left"
          ...
          variant === "floating" || variant === "inset"
            ...
            : "group-data-[collapsible=icon]:w-(--sidebar-width-icon) group-data-[side=left]:border-r border-dashed group-data-[side=right]:border-l",
          className
        )}
        {...props}
      >
